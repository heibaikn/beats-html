...
<template>
  <section>
    <div style="padding:5px 0 10px;">
      <Button type="success" @click="addModal">添加用户</Button>
    </div>
    ...
    <Modal v-model="modal1" width="450" @on-visible-change="modalVisibleChange">
    ...
    <Modal v-model="modal2" width="360">
      ...
      <div style="text-align:center">
        <p>您确定要删除“{{modal2Data.name}}”这个用户吗？</p>
      </div>
...
export default {
    ...
    return {
      ...
      columns1: [
        ...
        // },
        {
          ...
          key: "adminRole",
          render: (h, params) => {
            return h("div", null, this.roleName[params.row.adminRole]);
          }
        },
        {
          title: "手机号",
        ...
        },
        {
          ...
          key: "createDate",
          render: (h, params) => {
            return h("div", null, this.formatDateFun(params.row.createDate));
          }
        },
        {
          title: "操作",
          ...
          align: "center",
          render: (h, params) => {
            console.log(params.row.adminRole);
            if (params.row.adminRole == "0") {
              return;
            }
            // if(params.row)
            // console.log(this.checkRemoveadminRole);
  ...
  methods: {
    ...
    addModal() {
      console.log(this.formatDateFun);
      this.modal1 = true;
